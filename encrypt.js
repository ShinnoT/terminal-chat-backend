...
exports.encryptPass = async (rawPassword) => {
    const saltRounds = 10;
    const encryptedPass = await hash(rawPassword, saltRounds);
    return encryptedPass;
};

exports.comparePass = async ({ rawPass, correctPass }) => {
    const isCorrectPass = await compare(rawPass, correctPass);
